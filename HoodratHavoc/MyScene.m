...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
   ...
   // [self runAction:[SKAction playSoundFileNamed:@"sareeloop.mp3" waitForCompletion:NO]];
    ...
    // 9 - Create the actions
    float velocity = 480.0/2.0;
    float realMoveDuration = self.size.width / velocity;
    SKAction * actionMove = [SKAction moveTo:realDest duration:realMoveDuration];
    SKAction * spin = [SKAction repeatActionForever:[SKAction rotateByAngle:M_PI duration:0.25]];
    SKAction * fire = [SKAction group:@[actionMove, spin]];
    SKAction * actionMoveDone = [SKAction removeFromParent];
    [projectile runAction:[SKAction sequence:@[fire, actionMoveDone]]];
}
